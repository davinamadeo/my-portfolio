...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div
        aria-hidden="true"
        className="absolute left-6 top-0 h-full w-px bg-[#18130E]/10 md:left-12 lg:left-24"
      />
      ...
      <div className="relative mx-auto w-full max-w-5xl">
        ...
        <div className="overflow-hidden">
          ...
          >
            ...
            <span className="text-[#18130E]">.</span>
          </h1>
        </div>
        ...
        >
          <span className="h-px w-8 bg-[#18130E]/30" aria-hidden="true" />
          <p className="font-sans text-sm font-light tracking-widest text-neutral-400 uppercase">
            <span className="text-[#18130E]">{displayed}</span>
            <span
              className="ml-0.5 inline-block h-3.5 w-px animate-pulse bg-[#18130E]"
              aria-hidden="true"
            />
          </p>
        </div>
        ...
        >
          <button
            ...
            className="group relative inline-flex items-center gap-2 overflow-hidden rounded-full bg-[#18130E] px-6 py-3 text-sm font-medium text-[#F0EBE1] transition-all duration-300 hover:bg-[#3C3630]"
          >
          ...
          <button
            ...
            className="inline-flex items-center gap-2 rounded-full border border-[#C8C3BA] px-6 py-3 text-sm font-light text-neutral-500 transition-all duration-300 hover:border-[#18130E] hover:text-neutral-100"
          >
            Get in touch
          </button>
          ...
          <a
            ...
            className="inline-flex items-center gap-2 text-sm font-light text-neutral-600 transition-colors duration-200 hover:text-neutral-100"
          >
        ...
        {/* Stats */}
        <div
          className={`mt-16 flex flex-wrap gap-8 border-t border-[#C8C3BA] pt-8 transition-all duration-700 delay-500 ${
            mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
          }`}
        >
          {[
      ...
      >
        ...
        <div className="flex items-center gap-4">
          <a
            ...
            rel="noopener noreferrer"
            aria-label="GitHub"
            className="text-neutral-700 transition-colors duration-200 hover:text-neutral-100"
          >
